...
- SDK host, main/preload IPC, runtime-state schemas, process lifecycle, panels, or transitions: `docs/architecture/processes-and-ipc.md` and `docs/architecture/state-and-sessions.md`.
- Submission admission, queue custody/restoration, editor revisions, ESC, renderer/UI acknowledgements, or close/cap behavior: also read those two architecture docs and `docs/ui-conventions.md`.
- Composer/slash execution or command admission/settlement: `docs/architecture/commands.md` and `docs/architecture/command-matrix.md`.
